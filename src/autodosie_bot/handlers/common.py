...
HELP_TEXT = (
    ...
    "<code>А123ВС77</code>\n\n"
    "Сейчас /check и /checkvin собирают бесплатный агрегированный отчет, а /checkgibdd запускает отдельный официальный поток ГИБДД с капчей."
)
...
async def command_start(message: Message) -> None:
    await message.answer(
        ...
        "из доступных открытых источников, а для ГИБДД добавлен отдельный официальный сценарий с капчей.\n\n"
